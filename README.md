...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/click-params-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10005&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/click-params-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `click-params` can be installed with:

```
conda install click-params
```

It is possible to list all of the versions of `click-params` available on your platform with:
